...
export const SubsonicController: InternalControllerEndpoint = {
    ...
    getStreamUrl: async ({ apiClientProps, query }) => {
        ...
        const streamUrl = `${server?.url}/rest/stream.view?id=${id}&v=1.13.0&c=${window.WEB_TITLE || 'HMusic'}&${server?.credential}`;
